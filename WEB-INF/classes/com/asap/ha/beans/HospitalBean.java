...
public class HospitalBean implements java.io.Serializable,Comparable<HospitalBean>
{
...
{
if(!(object instanceof HospitalBean)) return false;
HospitalBean hospital=(HospitalBean)object;
return this.hospitalId.equalsIgnoreCase(hospital.hospitalId);
}
public int compareTo(HospitalBean hospital)
{
