...
<body background='/minorProject/images/img3.jpg;background-size:contain;background-attachment:fixed'>
...
Pharmacy Name : ${pharmacyBean.name}
</div>
<br><br>
<div class="col-md-12  font-ti text-white">
Pharmacy Address : ${pharmacyBean.address}
</div>
<br><br>
<div class="col-md-12 font-ti text-white">
Contact Number : ${pharmacyBean.contactNumber}
</div>
<br><br>
<div class="col-md-12 font-ti text-white">
About : ${pharmacyBean.aboutPharmacy}
</div>
<br><br>
<div class="container">
<div class="row">
...
<form id='cancelForm' action='/minorProject/Pharmacies.jsp'>
</form>
</div>
</div>
</div>
